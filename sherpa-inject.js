...
// This script injects Google Fonts, custom CSS, and all page content
...
(function() {
  ...
  fontLink.href = 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap';
  document.head.appendChild(fontLink);

  // 2. Inject CSS
  var style = document.createElement('style');
  style.textContent = `:root{--forest:#2E7D32;--forest-deep:#1B5E20;--forest-light:#4CAF50;--slate-900:#0F172A;--slate-800:#1E293B;--slate-700:#334155;--slate-400:#94A3B8;--slate-300:#CBD5E1;--slate-200:#E2E8F0;--slate-100:#F1F5F9;--cream:#FAFAF8;--white:#FFFFFF;--font-display:'Cormorant Garamond',Georgia,serif;--font-body:'DM Sans',-apple-system,sans-serif;--ease:cubic-bezier(0.16,1,0.3,1)}
  ...
  <div class="container">
    <div class="grid-2">
      ...
      <div class="img-frame reveal" style="aspect-ratio:4/5">
        ...
        <img src="https://images.unsplash.com/photo-1524168272322-bf73616d9cb5?auto=format&fit=crop&w=800&q=80" alt="Chicago River" loading="lazy">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="grid-2" style="gap:2rem">
      <div class="card reveal">
        ...
        <p style="margin-top:1.5rem"><a href="/bridge-loans" class="btn-primary" style="padding:0.7rem 2rem;font-size:0.7rem">Learn More</a></p>
      </div>
      <div class="card reveal">
  ...
  <div class="container">
    ...
    <div class="grid-3" style="margin-top:2rem">
        ...
        <div class="funded-card reveal">
          <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1-105-holiday-dr-n-macon-ga-primary-bridge-loan-secured-by-hotel.jpg" alt="CRE Bridge Loan — Hotel Acquisition" loading="lazy" onerror="this.style.display='none'">
        ...
        <div class="funded-card reveal">
          <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/buffalo-new-york-bridge-refinance-of-maturing-regional-bank-loan-office-and-mixed-use-building.jpg" alt="CRE Bridge Loan — Mixed-Use Refinance" loading="lazy" onerror="this.style.display='none'">
          <div class="funded-overlay">
            <span class="funded-label">Bridge Loan</span>
        ...
        <div class="funded-card reveal">
          <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/apartment-building-financing-chicago.jpg" alt="Acquisition & Rehab — 2 Apartment Buildings (19 Units)" loading="lazy" onerror="this.style.display='none'">
          <div class="funded-overlay">
            <span class="funded-label">Bridge Loan</span>
...
<section class="section bg-dark" style="text-align:center;position:relative;overflow:hidden">
  <div style="position:absolute;inset:0;background:url('https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?auto=format&fit=crop&w=1920&q=80') center/cover;opacity:0.08"></div>
  ...
  "/bridge-loans": `<section class="page-hero">
  ...
  <div class="container">
    <div class="grid-2">
      ...
      <div class="img-frame reveal" style="aspect-ratio:4/3">
        <img src="https://images.unsplash.com/photo-1565610222536-ef125c59da2e?auto=format&fit=crop&w=800&q=80" alt="Chicago commercial real estate" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
<section class="section bg-white">
  <div class="container">
    <div class="funded-grid">
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1-105-holiday-dr-n-macon-ga-primary-bridge-loan-secured-by-hotel.jpg" alt="CRE Bridge Loan — Hotel Acquisition" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/buffalo-new-york-bridge-refinance-of-maturing-regional-bank-loan-office-and-mixed-use-building.jpg" alt="CRE Bridge Loan — Mixed-Use Refinance" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/apartment-building-financing-chicago.jpg" alt="Acquisition & Rehab — 2 Apartment Buildings (19 Units)" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/9631920-orig.jpg" alt="Condo Building Ground Up Construction" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/chicago-single-family-homes-development-construction-financing.jpg" alt="Construction Financing — Single Family Development" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/3100061-orig.jpg" alt="Luxury Home Construction Financing" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/3242-n-clark-purchase-and-rehab-loan.jpeg" alt="Acquisition Loan — Mixed-Use Building" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/7802393_1.jpg" alt="Broken Condo Bulk Acquisition & Rehab" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/8387636-orig.jpg" alt="Acquisition & Rehab — 5 Single Family Homes" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/9794793-orig.jpg" alt="Spec Single Family Construction" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/181538-orig.jpg" alt="Loft Office Building" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/2225-w-north-ave-melrose-park-il-primary-photo-1-largehighdefinition.jpg" alt="2nd Lien Rehab — 300,000 Sq. Ft. Industrial" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/4421074-orig.jpeg" alt="Broken Condo Financing" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/9453983-orig.jpg" alt="Luxury Home Acquisition & Rehab" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/6929563-orig.jpg" alt="Acquisition & Rehab — Apartment Building" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1317765-orig.jpg" alt="Spec Single Family Construction" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/land-development-financing-single-family-homes.jpg" alt="Land Development — 17 Improved Lots" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/8712370-orig.jpg" alt="Refinance of Multiple Properties" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/2376343-orig.jpg" alt="Refinance of Spec Home" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/8583655-orig.jpg" alt="Construction Financing — New Homes" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/3910426-orig.jpg" alt="Acquisition & Rehab — 3 Single Family Homes" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/elston-lincoln-park-pic1-orig.jpg" alt="Office Building Development Loan" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/self-stoage-bridge-loan-2-orig.jpg" alt="Self Storage Facility" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/5409787-orig.jpg" alt="Acquisition & Rehab — 2 Single Family Homes" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/6698719-orig.jpg" alt="Acquisition & Rehab — Luxury Single Family Home" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/3007566-orig.jpg" alt="Acquisition & Rehab — Luxury Single Family Home" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/9909240-orig_1.jpg" alt="Acquisition & Rehab — Single Family Home" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/10586_1.jpg" alt="Value Add Retail Center" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/spec-construction-financing-orig.jpg" alt="Acquisition & Construction — Single Family Home" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Construction</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/2-cvg-airport-indutrial-land-bridge-loan.jpg" alt="CRE Bridge — Industrial Land Acquisition" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/missonibaia-condo-building-edgewater-miami-florida.jpg" alt="Luxury Condominium Investment Property" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1672761943145.jpeg" alt="Car Wash & Real Estate Acquisition" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1-el-paso-texas-medical-office-building-bridge-loan.jpg" alt="CRE Bridge — Medical Office Building" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/fort-myers-motel-bridge-loan-for-acquisition.jpg" alt="Motel Acquisition & Rehab Loan" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/townhome-development-rendering.jpg" alt="Bridge Land Loan — Townhome Development" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Land</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1-austin-neighborhood-chicago-acquistiion-loan-larrge-affordable-housing-project.webp" alt="Affordable Housing — 300-Unit SRO" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
      ...
      <div class="funded-card reveal">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/1-midwest-rd-oak-brook-il-building-bridge-loan-by-sherpa-capital-group.jpg" alt="Office Bridge Acquisition Loan" loading="lazy" onerror="this.parentElement.style.background='var(--slate-700)'">
        <div class="funded-overlay">
          <span class="funded-label">Bridge Loan</span>
...
<section class="section bg-cream">
  <div class="container">
    <div class="grid-2">
      ...
      <div class="img-frame reveal" style="aspect-ratio:4/3">
        <img src="https://images.unsplash.com/photo-1524168272322-bf73616d9cb5?auto=format&fit=crop&w=800&q=80" alt="Chicago residential real estate" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
<section class="section bg-white">
  <div class="container">
    <div class="grid-2">
      <div class="img-frame reveal" style="aspect-ratio:4/3">
        <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80" alt="Commercial real estate" loading="lazy">
      </div>
      <div class="reveal">
  ...
  <div class="container">
    ...
    <div class="grid-2" style="margin-bottom:4rem">
      <div class="img-frame reveal" style="aspect-ratio:3/4">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/published/ashish-parikh-sherpa-capital-group.jpg?1554828922" alt="Ashish Parikh" loading="lazy">
      </div>
      <div class="reveal">
    ...
    <div class="grid-2">
      ...
      <div class="img-frame reveal" style="aspect-ratio:3/4">
        <img src="http://www.sherpacapitalgroup.com/uploads/1/2/5/3/12533793/rahul-shah-sherpa-capital-group_orig.jpg" alt="Rahul Shah" loading="lazy">
      </div>
    </div>
  </div>
</section>
...
`
  ...
  if (!content) return; // Don't inject on pages we don't have content for (e.g. search)
  ...
  function inject() {
    ...
    var navHtml = '<nav class="nav" id="nav">' +
      '<a href="/" class="nav-logo"><img src="https://i.imgur.com/VGbfFM0.png" alt="Sherpa Capital Group" style="height:50px;width:auto;filter:brightness(0) invert(1);"></a>' +
