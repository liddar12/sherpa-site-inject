...
(function() {
  ...
  <div class="page-hero-content">
    <div class="hero-logo-mark"><img src="https://cdn.jsdelivr.net/gh/liddar12/sherpa-site-inject@main/assets/logo.png" alt="Sherpa Capital Group" style="height:200px;width:auto;filter:brightness(0) invert(1);"><div style="font-family:var(--font-body);font-size:1.4rem;letter-spacing:0.3em;text-transform:uppercase;color:#2E7D32;font-weight:700;margin-top:0.75rem;">Sherpa Capital Group</div></div>
