...
(function() {
  ...
  <div class="page-hero-content">
    <div class="hero-logo-mark"><img src="https://cdn.jsdelivr.net/gh/liddar12/sherpa-site-inject@main/assets/logo.png" alt="Sherpa Capital Group" style="height:270px;width:auto;filter:brightness(0) invert(1);"><div style="font-family:var(--font-body);font-size:0.85rem;letter-spacing:0.25em;text-transform:uppercase;color:var(--forest-light);font-weight:600;margin-top:0.5rem;">Sherpa Capital Group</div></div>
...
`
  ...
  function inject() {
    ...
    var navHtml = '<nav class="nav" id="nav">' +
      '<a href="/" class="nav-logo"><img src="https://cdn.jsdelivr.net/gh/liddar12/sherpa-site-inject@main/assets/logo.png" alt="Sherpa Capital Group" style="height:70px;width:auto;filter:brightness(0) invert(1);"><span style="font-size:0.65rem;letter-spacing:0.15em;text-transform:uppercase;color:var(--forest-light);font-weight:600;white-space:nowrap;">Sherpa Capital<br>Group</span></a>' +
